      ...
      <div className="flex flex-col justify-between items-center pt-8 pb-12 gap-8 w-screen h-full min-h-screen bg-black">
        ...
        <div className="flex justify-start items-start pt-[75px] pl-24 pr-24 rounded-[40px] w-[95vw] min-h-content bg-white">
          <div className="mt-3 flex flex-col space-y-[4vh] justify-start items-start w-[543px] ">
            ...
            <div className="mt-[8vh] ml-6 flex justify-center items-center rounded-[20px] w-[332px] h-16 bg-white border-[3px] border-black hover:bg-black hover:text-white">
              <button className="font-sora text-2xl  min-w-[175px] whitespace-nowrap text-opacity-100 leading-none font-medium ">
                Add BitsCoins
              </button>
            </div>
          </div>
          <div className="ml-[311px] relative w-11 h-[714px]">
