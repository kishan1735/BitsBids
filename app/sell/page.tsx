...
function Page() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      formData.set("basePrice", price);
      formData.set("userName", userName);
      formData.set("email", userEmail);
      formData.set("time", time);
      formData.set("academic", academic as any);
    ...
    <>
      <AuthCheck>
        <div className="flex flex-col justify-between items-center pt-6 pb-6 gap-8 w-screen h-full min-h-screen bg-black">
          ...
          <form
            className="flex justify-between items-start pt-14 pr-10 pl-[132px] gap-16 rounded-[40px] w-[96vw] h-full bg-white"
            id="form-xyz"
            onSubmit={handleSubmit}
          >
            <div className="mt-14 flex flex-col justify-between items-center gap-8 w-[407px] h-[516px]">
              <div className="flex flex-col space-y-4 justify-center items-center rounded-[20px] w-[35vw] h-[55vh] shadow-md bg-white">
